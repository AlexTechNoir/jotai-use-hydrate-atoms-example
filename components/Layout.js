  ...
  return (
    <>
      <div style={{ padding: '1em', fontFamily: 'Roboto, sans-serif', width: '1000px', lineHeight: 1.5 }}>
        This is a reproduction example for Jotai's useHydrateAtoms. This app has global Layout component, that has useEffect. With empty arr of deps, useEffect should launch only on Layout's mount, but because of useHydrateAtoms, Layout remounts on every route change, causing useEffect to relaunch as well. To see it, open console and click on links
      </div>
      {children}
    </>
  )
